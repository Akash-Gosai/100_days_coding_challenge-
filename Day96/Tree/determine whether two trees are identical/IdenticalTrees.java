public class IdenticalTrees {  
    ...
    public static void main(String[] args) {  
      ...
      bt1.root.left = new Node(22);  
      bt1.root.right = new Node(33);  
      bt1.root.left.left = new Node(44);  
      bt1.root.right.left = new Node(55);  
      bt1.root.right.right = new Node(66);  
        
      //Adding nodes to the second binary tree  
        IdenticalTrees bt2 = new IdenticalTrees();  
        bt2.root = new Node(11);  
        bt2.root.left = new Node(22);  
        bt2.root.right = new Node(33);  
        bt2.root.left.left = new Node(44);  
        bt2.root.right.left = new Node(55);  
        bt2.root.right.right = new Node(66);    
